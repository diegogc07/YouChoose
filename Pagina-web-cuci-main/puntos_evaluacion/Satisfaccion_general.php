...
<head>
  ...
  <title>Satisfacci&oacute;n general</title>
...
<input type="hidden" value="general" name="categoria">
    <div class="container-fluid mt-4">
      <table class="table table-bordered border-dark">
        <thead>
          <tr class="celdas_principales">
            <th scope="col">Satisfacci&oacute;n general</th>
        ...
        <tbody class="fondo">
          <tr>
            <td width="709">En general, pienso que es un buen docente.</td>
            <td colspan="10" width="240"><input type="range" class="form-range" min="20" max="100" step="20" id="vol1" name="vol1"></td>
          </tr>
          <tr>
            <td>Estoy satisfecha o satisfecho por mi nivel de desempe&ntilde;o y aprendizaje logrado gracias a la labor del docente.</td>
            <td colspan="10"><input type="range" class="form-range" min="20" max="100" step="20" id="vol2" name="vol2"></td>
          </tr>
          <tr>
            <td>Yo recomendar&iacute;a a este docente.</td>
