...
<head>
  ...
  <title>Gesti&oacute;n del curso</title>
...
<input type="hidden" value="gestion" name="categoria">
    <div class="container-fluid mt-4">
      <table class="table table-bordered border-dark">
        <thead>
          <tr class="celdas_principales">
            <th scope="col">Gesti&oacute;n del curso</th>
        ...
        <tbody class="fondo">
          <tr>
            <td width="709">Asiste a clases regular y puntualmente.</td>
            <td colspan="10" width="184"><input type="range" class="form-range" min="20" max="100" step="20" id="vol1" name="vol1"></td>
          </tr>
          <tr>
            <td>Fomenta la importancia de contribuir a la conservaci&oacute;n del medio ambiente.</td>
          ...
          <tr>
            <td>Es accesible y est&aacute; dispuesto a brindarte ayuda acad&eacute;mica.</td>
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-end">
        ...
        <a href="Tecnologias_informacion_comunicacion.php?id_maestro=<?= $id_maestro?>">
