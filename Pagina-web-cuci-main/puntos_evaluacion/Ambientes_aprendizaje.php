...
<head>
  ...
  <title>Ambientes de aprendizaje</title>
...
<?php $id_maestro = $_GET["id_maestro"]?>
  <form name="valuate" method="post" action="../insertarEval.php">
    ...
    <input type="hidden" value="ambientes" name="categoria">
    <div class="container-fluid mt-4">
      <table class="table table-bordered border-dark">
        <thead>
          <tr class="celdas_principales">
            <th scope="col">Ambientes de aprendizaje</th>
        ...
        <tbody class="fondo">
          <tr>
            <td width="709">Incluye experiencias de aprendizaje en lugares diferentes al aula (talleres, laboratorios, empresa, comunidad, etc.).</td>
            <td colspan="10" width="319"><input type="range" class="form-range" min="20" max="100" step="20" id="vol1" name="vol1"></td>
          </tr>
          <tr>
