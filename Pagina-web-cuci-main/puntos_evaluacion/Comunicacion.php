...
<input type="hidden" value="comunicacion" name="categoria">
    <div class="container-fluid mt-4">
      <table class="table table-bordered border-dark">
        ...
        <tbody class="fondo">
          <tr>
            <td width="709">Desarrolla la clase en un clima de apertura y entendimiento.</td>
            <td colspan="10" width="173"><input type="range" class="form-range" min="20" max="100" step="20" id="vol1" name="vol1"></td>
          </tr>
          <tr>
